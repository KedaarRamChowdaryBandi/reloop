...
st.markdown(f"""
<div class="reloop-card" style="border-color: rgba(0, 230, 118, 0.2); background: rgba(7,27,23,0.4);">
    <div style="display: flex; justify-content: space-between; align-items: center;">
        <div>
            <h4 style="color: #aaa; margin: 0;">Market Index Rate ({material_cat})</h4>
            <h1 style="color: #00E676; margin: 5px 0;">₹{reference_price:.2f} <span style="font-size: 16px; color:#aaa;">/ kg</span></h1>
        </div>
...
if not listings:
    ...
    with col_stats:
        ...
        health_color = "#00E676" if avg_price <= reference_price else "#ff5252"
        
        st.markdown(f"""
        <div class="reloop-card" style="text-align: center; border-color: {health_color};">
            <h4 style="color:#aaa;">Average Listing Price</h4>
            <h2 style="color: white; margin: 10px 0;">₹{avg_price:.2f} / kg</h2>
            ...
            with col_d1:
                ...
                <div class="reloop-card">
                    <div style="display:flex; justify-content:space-between;">
                        <h4 style="margin:0; color:#00E676;">{deal['material'].title()} (by {deal['supplier_name']})</h4>
                        <span class="badge-verified" style="background-color:#123524; color:#00E676;">Save {((reference_price - deal['price_per_kg'])/reference_price*100):.0f}%</span>
                    </div>
