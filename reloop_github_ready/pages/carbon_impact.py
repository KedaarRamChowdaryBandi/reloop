...
with col1:
    st.markdown(f"""
    <div class="reloop-card" style="text-align: center; border-color: #00E676; height: 180px;">
        <div style="font-size: 30px; margin-bottom: 5px;">🌲</div>
        <h4 style="color:#aaa; font-size:13px; margin: 0;">Tree Seedlings</h4>
        <h2 style="color:#00E676; margin: 10px 0;">{trees_equivalent:,.1f}</h2>
        <p style="color:#888; font-size:10px;">Seedlings grown for 10 yrs</p>
    </div>
...
with col2:
    ...
    <div class="reloop-card" style="text-align: center; border-color: #00E676; height: 180px;">
        <div style="font-size: 30px; margin-bottom: 5px;">🚗</div>
        <h4 style="color:#aaa; font-size:13px; margin: 0;">Cars Off Road</h4>
        <h2 style="color:#00E676; margin: 10px 0;">{cars_equivalent:,.2f}</h2>
        <p style="color:#888; font-size:10px;">Passenger vehicles off road/yr</p>
    </div>
    """, unsafe_allow_html=True)
...
with col3:
    ...
    <div class="reloop-card" style="text-align: center; border-color: #00E676; height: 180px;">
        <div style="font-size: 30px; margin-bottom: 5px;">📱</div>
        <h4 style="color:#aaa; font-size:13px; margin: 0;">Phone Charges</h4>
        <h2 style="color:#00E676; margin: 10px 0;">{phones_equivalent:,.0f}</h2>
        <p style="color:#888; font-size:10px;">Smartphones charged avoided</p>
    </div>
    """, unsafe_allow_html=True)
...
with col4:
    ...
    <div class="reloop-card" style="text-align: center; border-color: #00E676; height: 180px;">
        <div style="font-size: 30px; margin-bottom: 5px;">🏠</div>
        <h4 style="color:#aaa; font-size:13px; margin: 0;">Home Power</h4>
        <h2 style="color:#00E676; margin: 10px 0;">{homes_equivalent:,.2f}</h2>
        <p style="color:#888; font-size:10px;">Homes electricity offset/yr</p>
    </div>
    """, unsafe_allow_html=True)
