...
if not orders:
    ...
    for o in orders:
        ...
        if o["status"] == "completed" or o["status"] == "Delivered":
            ...
            status_badge = '<span class="badge-info">🚚 Shipped</span>'
        else:
        ...
        <div class="reloop-card">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
                <h3 style="margin: 0; color: #10B981;">♻️ {o['material'].title()}</h3>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 15px; font-size: 14px; color: #CBD5E1;">
                ...
                <div><strong>Total Transaction Value:</strong> <span style="color:#10B981; font-weight:bold;">₹{o['total_price']:.2f}</span></div>
