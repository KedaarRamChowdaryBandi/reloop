...
if not listings:
    ...
    with col_stats:
        ...
        st.markdown(
            ...
            ">
                <h4 style="color:#94A3B8;">Average Listing Price</h4>
                <h2 style="color:#F8FAFC !important; -webkit-text-fill-color:#F8FAFC !important;">₹{avg_price:.2f}/kg</h2>
                <div style="color:{health_color};font-weight:bold;font-size:16px;">
                    {price_health}
                </div>
    ...
    if fair_deals:
        ...
        for deal in fair_deals:
            ...
            with col_d1:
                ...
                st.markdown(
                    f"""
                    <div class="reloop-card" style="margin-bottom:10px;">
